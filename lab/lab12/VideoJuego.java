...
public class VideoJuego {
  ...
  public static void crearSoldado(Soldado[][] t, ArrayList<Soldado> e, String team) {
    ...
    s.setColumna(sc.next().toUpperCase().charAt(0) - 65);
  ...
  public static void clonarSoldado(Soldado[][] t, ArrayList<Soldado> e, String team) {
    ...
    int newCol = sc.next().toUpperCase().charAt(0) - 65;
  ...
  public static void compararSoldado(Soldado[][] t, ArrayList<Soldado> e, String team) {
    ...
    System.out.println("Ingresa la ubicacion del primer soldado: ");
    System.out.print("Ingresa la columna: ");
    int col1 = sc.next().toUpperCase().charAt(0) - 65;
    System.out.print("Ingresa la fila: ");
    int fila1 = sc.nextInt() - 1;

    System.out.println("Ingresa la ubicacion del segundo soldado: ");
    System.out.print("Ingresa la columna: ");
    int col2 = sc.next().toUpperCase().charAt(0) - 65;
    System.out.print("Ingresa la fila: ");
    int fila2 = sc.nextInt() - 1;

    System.out.println(col1 + " | " + fila1);
    System.err.println(t[fila1][col1]);
    Soldado s1 = t[fila1][col1];
    Soldado s2 = t[fila2][col2];
    if (
      s1.getNivelAtaque() == s2.getNivelAtaque()
      && s1.getNivelDefensa() == s2.getNivelDefensa()
      && s1.getNivelVida() == s2.getNivelVida()
  ...
  public static void intercambiarSoldado(Soldado[][] t, ArrayList<Soldado> e, String team) {
    ...
    Soldado s = t[fila1][col1];
    t[fila1][col1] = t[fila2][col2];
    t[fila2][col2] = s;
  }
  public static void verSoldado(Soldado[][] t, ArrayList<Soldado> e, String team) {
    ...
    System.out.println(t[fila][col]);
  }
  public static void verEjercito(Soldado[][] t, ArrayList<Soldado> e, String team) {
    System.out.println("Lista de todos los soldados: ");
    for(Soldado s : e) System.out.println(s);
  }
